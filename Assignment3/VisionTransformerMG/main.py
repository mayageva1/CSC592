...
def configure_optimizers(mymodel):
    ...
    blacklist_weight_modules = (torch.nn.LayerNorm, torch.nn.Embedding) #,torch.nn.Parameter, torch.nn.Conv2d
    ...
    for i in tqdm.tqdm(range(start,NUM_EPOCHS), mininterval = 10., desc = 'training'):
        ...
        if i % VALIDATE_EVERY == 0:
            ...
            if accuracy > best_test_accuracy:
                ...
                ckpt_path = os.path.join("checkpoint/visiontrans_model.pt")
